                            ...
                            <div class="row m-0">
                                ...
                                <div class="col-lg-6 col-12 p-0">
                                    <div class="card rounded-0 mb-0 px-2 py-1">
                                        ...
                                        @if (session('status'))
                                            <p class="px-2 mt-1 mb-0 font-weight-bold">{{ session('status') }}</p>
                                        @endif
                                            ...
                                            <div class="card-body">
                                                <form action="{{ route('password.email') }}" method="POST">
                                                    ...
                                                    <div class="form-label-group">
                                                        <input type="email" id="email" name="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email') }}" placeholder="Email" autocomplete="off">
                                                        @error('email')
